...
public class ShoppingCartTest {
    ...
    public void formatTicket() {
        ...
        cart.addItem("Juice", 17.20, 1, ShoppingCart.ItemType.SALE);
        cart.addItem("Potatoes", 2.00, 500, ShoppingCart.ItemType.REGULAR);

        String expected = "# Item      Price Quan. Discount   Total \n" +
                "----------------------------------------\n" +
                "1 Apple      $.99     5        -   $4.95 \n" +
                "2 Banana   $20.00     4      50%  $40.00 \n" +
                "3 Juice    $17.20     1      70%   $5.16 \n" +
                "4 Potatoes  $2.00   500      50% $500.00 \n" +
                "----------------------------------------\n" +
                "4                                $550.11 ";
